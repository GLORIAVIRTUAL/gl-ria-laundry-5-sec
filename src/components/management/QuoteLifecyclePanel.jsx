...
export default function QuoteLifecyclePanel({ quotes = [], customers = [], selectedUnitId, onRefresh }) {
  ...
  return (
    <section className="space-y-5">
      <div><h2 className="text-xl font-semibold text-white">Ciclo dos orçamentos</h2><p className="text-sm text-white/45">Validade, versões e decisões comerciais sem apagar o histórico.</p><p className="mt-1 text-xs text-white/35">{scopedQuotes.length} orçamento(s) no período selecionado.</p></div>
